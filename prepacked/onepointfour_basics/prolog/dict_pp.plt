...
:- begin_tests(dict_prettyprint_nonrecursive).
...
:- end_tests(dict_prettyprint_nonrecursive).

:- begin_tests(dict_prettyprint_recursive).
...
:- end_tests(dict_prettyprint_recursive).
